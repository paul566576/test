...
INSERT INTO `customer` (`name`, `email`, `mobile_number`, `pwd`, `role`, `create_at`)
VALUES ('admin', 'admin@test.com', '+380660259914',
        '{bcrypt}$2a$12$iOeg8WABoDyD41v2pmVqfuW8aK5n1xKdiIa.dnOyCk07ccLclL0pu', 'ADMIN', CURDATE()),
       ('user', 'user@test.com', '+380660259913',
        '{bcrypt}$2a$12$HOG1OFZwNwS8xFxLmGXw8eyLqgXmb6yM4WdSbLIkOxRY4uSZ5LzCq', 'USER', CURDATE());
#Tele@admin1234!
#Tele@user1234!
...
values (1, 1865764534, 'Savings', '123 First Street, New Yourk', curdate()),
       (2, 1865764535, 'Savings', '123 Second Street, New Yourk', curdate());
